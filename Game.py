...
def getColored_Eye(eye_points,facial_landmarks,frame):
...
def true():
    ...
    for face in faces:
        ...
        #gaze detection
        gaze_left_eye_side_ratio,gaze_left_eye_topDown_ratio=get_gaze_ration([36,37,38,39,40,41],landmarks,frame,gray)
        gaze_right_eye_side_ratio, gaze_right_eye_topDown_ratio = get_gaze_ration([42, 43, 44, 45, 46, 47], landmarks,frame,gray)
